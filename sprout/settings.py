...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'https://sproutdrewhill.fly.dev', 'sproutdrewhill.fly.dev']
CSRF_TRUSTED_ORIGINS = ['http://sproutdrewhill.fly.dev', 'https://sproutdrewhill.fly.dev']
